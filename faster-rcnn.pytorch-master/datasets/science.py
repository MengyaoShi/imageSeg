...
class science(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'science' + image_set)
        self._year = 2018
        self._image_set = image_set
        self._devkit_path = self._get_default_path() if devkit_path is None \
            else devkit_path
        self._data_path = os.path.join(self._devkit_path, image_set)
        self._image_path = os.path.join(self._data_path, 'image')
    ...
    def image_path_from_index(self, index):
        ...
        image_path = os.path.join(self._image_path,
                                  index, 'images', index + self._image_ext)
        #image_path = os.path.join(self._data_path, 'JPEGImages',
        #                          '{:06d}'.format(index) + self._image_ext)
    ...
    def _load_image_set_index(self):
        ...
        image_set_path = self._image_path
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'science')
